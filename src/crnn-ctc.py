...
i = 1
flag = 0
path = r"D:\Học tập\KH3 23-24\CRNN\CRNN_temp\1"
...
training_img = np.array(training_img).reshape(-1, 32, 128, 1)
train_input_length = np.array(train_input_length)
train_label_length = np.array(train_label_length)

valid_img = np.array(valid_img).reshape(-1, 32, 128, 1)
...
act_model.load_weights('best_model.keras')
